...
1. 添加提醒：  
   /remind 添加提醒 <内容> <时间> [星期] [重复类型] [节假日类型]  
   * 例如：/remind 添加提醒 写周报 8:05 mon weekly  
   * 例如：/remind 添加提醒 上班打卡 8:30 daily workday（每个工作日）  
   * 例如：/remind 添加提醒 休息提醒 9:00 daily holiday（每个法定节假日）  
2. 添加任务：  
   /remind 添加任务 <内容> <时间> [星期] [重复类型] [节假日类型]  
   * 例如：/remind 添加任务 发送天气预报 8:00 daily  
   * 例如：/remind 添加任务 工作安排 9:00 mon weekly workday（每周一工作日）  
3. 查看所有提醒和任务：  
   【/remind 列表】 或 【自然语言】  
4. 删除指定提醒或任务：  
   /remind 删除 <序号>  
   * 例如：删除第1个提醒 /remind 删除 1  
5. 查看帮助信息：  
   /remind 帮助
